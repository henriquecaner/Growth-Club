...
- **Vínculo de 3 anos**, condicional a entrega upfront (90 dias) + manutenção leve (6h/mês)
...
- Issues + Discussions estruturados
...
```mermaid
flowchart TD
    A[Você acha o Growth Club] --> B{O que carrega?}
    B -->|Curiosidade pura| C[Assina a newsletter Substack<br/>2.261 subs · semanal]
    B -->|Quer ouvir antes de falar| D[Vai num Meetup Growth<br/>~2 meses · rotação SP/RJ/BH/POA]
    B -->|Tem caso com número| E[Entra na comunidade WhatsApp<br/>via ingresso de meetup]
    C -->|Engajou na newsletter| D
    D -->|Pegou ingresso| F[Growth Hacker · free<br/>tier zero, 12 meses de lock inicial]
    E --> F
    F -->|Quer profissionalizar mais| G[Growth Hacker Master<br/>R$ 990/ano · abre jun/2027]
    F -.->|Quem fundou junto| H[Founder Member<br/>parqueado 2026-04]
    F -.->|Quem construiu o Crew| I[Founder Crew Era Pré-S1<br/>3 cadeiras · revshare]
```
...
| **Founder Member** | Cota única de 100, 3 anos pré-pagos | R$ 2.079 | ⏸️ Parqueado até retomada |
...
gantt
    ...
    Reavaliação Founder Member parqueado         :p2b, 2026-12, 1w
    section Fase 3
    Lock + Master R$990/ano                     :p3, 2027-06, 12M
```
...
1. **Se não tem número, não é Growth Club.** Caso, claim, promessa — tudo com evidência. Post/issue sem número vira redirecionamento cordial.
...
5. **Sem "evento" sozinho.** A palavra sempre vem com "comunidade" + marca. Princípio fundacional: **queremos a maior comunidade, não o maior evento.**
...
**Bandeira erguida por:** [Henrique Caner](https://linkedin.com/in/henriquecaner) — solo desde 2015, agora abrindo cadeiras.
