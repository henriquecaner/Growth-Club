...
> Build-in-public log. **Decisões + execuções + lições** da operação da comunidade. Espelho público (filtrado) das ADRs registradas em [`STATE.md`](.specs/project/STATE.md).
>
> Régua editorial: tudo aqui vem com data, decisão, e (quando aplicável) número que sustenta.

---

## 2026-04-28 · Estrutura pública do repositório

**Decisão:** Publicar o repositório como ativo de marca.
...
**Decisão:** Founder Crew receberá relatório financeiro mensal (1º ano) e trimestral (depois) com DRE simplificada, cálculo do líquido, Pool Crew e fração individual. Direito a contestar cálculos (right-to-audit-lite).

**Por quê:** sem visibilidade sobre receitas/despesas, o vínculo de revshare vira "confia em mim" — assimetria que corrói a relação. Princípio "Se não tem número, não é Growth Club" se aplica internamente também.

**Ref:** [`STATE.md` AD-005](.specs/project/STATE.md) · vai virar Cláusula 7 e Anexo E do Acordo de Founder Crew.

---

## 2026-04-28 · AD-004 · Hospedagem operacional na Level Tech (CNPJ existente)

**Decisão:** Comunidade roda dentro do CNPJ da **Level Tech** (recém-fundada pelo Henrique) em Fase 1. Spin-off futuro em CNPJ dedicado Growth Club, com Level Tech como holding controladora, gatilhado por: receita anual ≥ R$ 500k OU ≥ 200 GH Master pagantes OU captação externa relevante.

**Por quê:** §11 do Business Plan (CNPJ + regime tributário) era pendente. Level Tech existe e pode operar a Comunidade sem custo adicional de PJ nova em Fase 1.

**Ref:** [`STATE.md` AD-004](.specs/project/STATE.md).

---

## 2026-04-28 · AD-003 · Founder Member tier parqueado

**Decisão:** Tier `Founder Member` (R$ 2.079, 100 vagas) **suspenso temporariamente**. Não será ofertado em Barte S1E1.
...
**Por quê:** vender ticket prêmio antes do produto estar minimamente maduro queima a categoria. Receita upfront prevista de **R$ 51.975** (25 × R$ 2.079) não materializa em Barte S1E1 — gera **risco R-11** (cash flow Fase 1).

**Mitigação:** Henrique absorve o gap pessoalmente. Não haverá pre-sale GH Master forçado nem ingressos pagos comerciais agressivos pra cobrir gap em curto prazo. Princípio: *"Não tem promessa de dinheiro no curto prazo."*

**Ref:** [`STATE.md` AD-003](.specs/project/STATE.md).

---

## 2026-04-28 · AD-002 · Founder Crew (categoria Era Pré-S1)

**Decisão:** Cria-se 4ª categoria — **Founder Crew** — paralela aos tiers de membership. Remunera 3 operadores que entregam frentes técnicas críticas via revshare contratual sem participação societária.
...
- **Saída = perde tudo automaticamente** (revshare + crédito ativo)
- **Mecanismo legal:** acordo de prestação de serviços com remuneração variável (Caminho B, sem equity)

**Ref:** [`STATE.md` AD-002](.specs/project/STATE.md) · contrato draftado em `docs/contracts/acordo-founder-crew.md` (privado).

---

## 2026-04-22 · AD-001 · Business Plan v1.2 aprovado

**Decisão:** Design do business plan v1.2 aprovado por revisão independente (2 iterações) e pelo autor humano. Versão congelada no commit `1e374bf`.
...
**Ref:** [`docs/superpowers/specs/2026-04-22-growth-club-business-plan-design.md`](docs/superpowers/specs/2026-04-22-growth-club-business-plan-design.md) · [`STATE.md` AD-001](.specs/project/STATE.md).
...
- **2015** — Primeiro Meetup Growth presencial · São Paulo
...
> Histórico informal. Sem ADR formal porque essas decisões foram tomadas pelo Henrique solo, sem documentação estruturada — registradas aqui post-facto pra contexto. Detalhes editoriais: [`brand/voice/manifesto.md`](brand/voice/manifesto.md).
...
**Aprendizado:** Misturar consumidor pagante (paga acesso) com trabalhador trocando labor por upside corrompe a narrativa de ambos. Quando dois grupos têm naturezas jurídicas/comerciais diferentes, **separar nomenclatura** mesmo que o cap-table fique mais complexo.

### L-001 · 2026-04-22 · Ativos orgânicos preexistentes mudam a natureza do design

**Contexto:** Brainstorming inicial assumia greenfield; ativos preexistentes (2.261 + 715 + 10+ meetups) só foram revelados no meio do processo.
