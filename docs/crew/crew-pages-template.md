...
- [Entrega 1]. [Número e resultado.]
- [Entrega 2]. [Número e resultado.]
- [Entrega 3]. [Número e resultado.]
...
- Site ou portfólio pessoal: [opcional]
...
- Usa número em pelo menos 2 bullets do "O que entreguei".
- Inclua link LinkedIn (obrigatório). Outros são opcionais.
- Bio em primeira pessoa, com voz própria.
- Cita ferramentas e stack pelo nome oficial (régua [`CONVENTIONS.md`](../../.specs/project/CONVENTIONS.md)).
...
- Saída por qualquer causa: subpágina autoral é arquivada ou redirecionada.
...
- Não é possível "manter sua subpágina como portfólio externo" após saída. A subpágina morre. Pra portfólio próprio, replicar conteúdo no seu site ou LinkedIn antes da saída.
...
- Slug = primeiro nome em snake_case (ex: `mariana-silva` vira `/crew/mariana-silva`).
- Imagem de header: foto profissional do Crew member (consentimento explícito) com paleta primária Growth Club.
- SEO: meta description é a primeira frase da bio.
- Open Graph: imagem padrão Growth Club com nome do Crew.
